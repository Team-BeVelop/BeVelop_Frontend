        ...
        <>
            <Wrap>
                ...
                <Introduce>
                    <Title>프로젝트 소개</Title>
                    <Content>
                        스트릿 패션을 올리고 판매할 수 있는 패션 스타트업
                        플랫폼입니다. 피그마 사용하시고 패션에 관심 많으신
                        UI디자이너를 구하고 있습니다. 함께 서비스를 이끌어 가고
                        싶습니다. 스트릿 패션을 올리고 판매할 수 있는 패션
                        스타트업 플랫폼입니다. 피그마 사용하시고 패션에 관심
                        많으신 UI디자이너를 구하고 있습니다. 함께 서비스를
                        이끌어 가고 싶습니다. 스트릿 패션을 올리고 판매할 수
                        있는 패션 스타트업 플랫폼입니다. 피그마 사용하시고
                        패션에 관심 많으신 UI디자이너를 구하고 있습니다. 함께
                        서비스를 이끌어 가고 싶습니다 함께 서비스를 이끌어 가고
                        싶습니다. 스트릿 패션을 올리고 판매할 수 있는 패션
                        스타트업 플랫폼입니다. 피그마 사용하시고 패션에 관심
                        많으신 UI디자이너를 구하고 있습니다. 함께 서비스를
                        이끌어 가고 싶습니다.
